/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: dcb1fccaa6b91aab343ec968214eaee0)
// Runtime types generated with workerd@1.20260210.0 2026-02-10 nodejs_compat
declare namespace Cloudflare {
	interface Env {
		ASSETS: Fetcher;
		FONT_PATHS: string;
		FONT_LOAD_CONCURRENCY: string;
	}
}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "FONT_PATHS" | "FONT_LOAD_CONCURRENCY">> {}
}
